...
8. **Update `docs/libraries/gesha.md`** with the new component section (methods, properties, example, algorithm description).
...
- [ ] `uv run --locked --group dev pytest tests/test_KafeGESHA.py` passes
...
- [ ] Context saving verified — all of these exist:
  ...
  - [ ] `docs/libraries/gesha.md` updated
